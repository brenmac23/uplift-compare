...
- [ ] **SCORE-03**: User enters raw production data (percentages, dollar amounts, personnel counts) and app auto-calculates points for both systems
- [ ] **SCORE-04**: Shared input fields feed both scoring systems where criteria overlap
